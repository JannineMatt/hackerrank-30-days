...
takes an integer, , as a parameter. The constructor must assign to after confirming
...
creates each instance of your Person class is in the main method.
...
specifications outlined above; the code to test your work is already
in the editor. If your methods are implemented correctly, each test case will
print or lines (depending on whether or not a valid was passed
to the constructor).
'''
